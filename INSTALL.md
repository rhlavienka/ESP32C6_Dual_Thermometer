# Installation Guide - ESP32-H2 Development Environment for Windows

This guide will step-by-step walk you through installing all necessary software on a Windows PC for developing, compiling, and uploading programs to **Seeed Studio ESP32-H2 Super Mini** using **ESP-IDF** and **Visual Studio Code**.
...
- **USB-C cable** for connecting ESP32-H2
...
### Step 3.3: Setting Up USB Drivers for ESP32-H2

1. **Connect ESP32-H2 to PC:**
   - Use a USB-C cable (that supports data!)
   - Connect ESP32-H2 Super Mini to PC
...
2. **Open project:**
   - `File` → `Open Folder...`
   - Select project folder: `C:\ESP32\H2_Thermometer`
   - Click **"Select Folder"**
...
3. **Wait for completion:**
   - Extension will configure the project for ESP32-H2
...
4. **If errors occurred:**
   ...
   - Verify that you have the correct target set (ESP32H2)
   - Check that all project files are present

### Step 4.6: Uploading Program to ESP32-H2 (Flash)

1. **Verify connection:**
   - ESP32-H2 is connected via USB
...
2. **Monitor logs:**
   - You will see ESP32-H2 boot output
...
### Problem: "Failed to connect to ESP32-H2"
...
3. `Ctrl+Shift+P` → **"ESP-IDF: Set Espressif Device Target"** → `ESP32H2`
...
- **Seeed ESP32-H2 Super Mini Wiki:** https://wiki.seeedstudio.com/xiao_ESP32H2_getting_started/
...
**Congratulations! Your development environment is ready to work with ESP32-H2! 🎉**
